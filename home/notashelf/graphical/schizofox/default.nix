...
in {
  options.modules.programs.schizofox = {
    ...
    extraSecurity = mkOption {
      type = types.bool;
      default = false;
      description = "Enable the sheer amount of security options from ArkenFox";
    };
    ...
    home.packages = with pkgs; [
      (wrapFirefox firefox-esr-102-unwrapped {
        ...
        extraPolicies = {
          ...
          # TODO: use mkMerge here to seperate security and qol options
          Preferences = (mkIf cfg.extraSecurity) {
